...
type Repository interface {
	...
	DeletePromptHistoryByTelegramID(ctx context.Context, tx pgx.Tx, telegramID string) error
...
type UseCase interface {
	...
	ClearPromptHistoryByTelegramID(ctx context.Context, telegramID string) error
